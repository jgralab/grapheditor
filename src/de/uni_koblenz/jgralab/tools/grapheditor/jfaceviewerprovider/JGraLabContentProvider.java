...
/**
 * Content provider for a GraphViewer, works with a JGraLab Graph as input element
 * 
 * @author kheckelmann
 *
 */
public class JGraLabContentProvider implements IGraphEntityRelationshipContentProvider {
